...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLog48.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingReadsUsed48.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/valReadsUsed48.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints48'
validationSplit = 0.2

f_checkpoint = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints38/weights.03-0.44.h5'
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    # Stage 2
    X = convolutional_block(X, f = 15, filters = [64, 64, 64, 64, 64, 64], stage = 2, block='a', s = 1)
    #X = identity_block(X, 4, [64, 64, 256], stage=2, block='b')
    #X = identity_block(X, 4, [64, 64, 256], stage=2, block='c')

    # Stage 3
    X = convolutional_block(X, f=15, filters=[64, 64, 64, 64, 64, 64], stage=3, block='a', s=2)
    ...
    # Stage 4
    X = convolutional_block(X, f=15, filters=[64, 64, 64, 64, 64, 64], stage=4, block='a', s=2)
    ...
    # Stage 5
    X = convolutional_block(X, f=15, filters=[64, 64, 64, 64, 64, 64], stage=5, block='a', s=2)
...
readIDs = []
f_readIDs = open('/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/data_DNAscentTrainingData_highIns_noBrdUScaling_wellMixed.IDs','r')
