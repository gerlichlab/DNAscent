...
from tensorflow.python.keras.models import Sequential, model_from_json, Model, Concatenate
from tensorflow.python.keras.layers import Dense, Dropout, ZeroPadding1D, Layer, LSTM, Bidirectional
...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLogCTC_11.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingReadsUsedCTC_11.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/valReadsUsedCTC_11.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpointsCTC_11_pt2'
validationSplit = 0.2

f_checkpoint = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpointsCTC_11/weights.13.h5'
...
def buildModel():
	...
	X_input_signal = Input(name='signal_input',shape=(None,2))
	X_input_sequence = Input(name='sequence_input',shape=(None,4))
	...
	X = Conv1D(5, 4, strides = 1, padding='same', name = 'conv4', kernel_initializer = glorot_uniform(seed=0))(X)
	X = Flatten()(X)

	Y = Bidirectional(LSTM(5, return_sequences=True))(X_input_sequence)
	Y = Bidirectional(LSTM(5, return_sequences=True))(Y)
	Y = Bidirectional(LSTM(5, return_sequences=True))(Y)
