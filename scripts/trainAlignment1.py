...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLog_alignment1.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingReadsUsed_alignment1.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/valReadsUsed_alignment1.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/alignment1'
validationSplit = 0.2
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
	...
	#events stack
	E = Bidirectional(LSTM(2, return_sequences=True))(input_events)
	E = Bidirectional(LSTM(2, return_sequences=True))(E)
	E = Bidirectional(LSTM(2, return_sequences=True))(E)
	
	#base sequence stack
	S = Bidirectional(LSTM(2, return_sequences=True))(input_baseSequence)
	S = Bidirectional(LSTM(2, return_sequences=True))(S)
	S = Bidirectional(LSTM(2, return_sequences=True))(S)

	#past actions stack
	A = LSTM(4, return_sequences=True)(input_actions)
	A = LSTM(4, return_sequences=True)(A)
	A = LSTM(4, return_sequences=True)(A)

	#past matches stack
	M = LSTM(4, return_sequences=True)(input_matches)
	M = LSTM(4, return_sequences=True)(M)
	M = LSTM(4, return_sequences=True)(M)	
