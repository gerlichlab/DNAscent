...
for line in f:
	...
	if line[0] == '>':
		...
		if not first:
			...
			f_bg.write( 'track type=bedGraph name="'+readID + '_forkLeft'+'" description="BedGraph format" visibility=full color=200,100,0 altColor=0,100,200 priority=20 viewLimits=0.0:1.0'+'\n')
		...
		buffer_prob.append( chromosome + ' ' + str(prevPos) + ' ' + str(pos) + ' ' + str(probBrdU) + '\n' )
