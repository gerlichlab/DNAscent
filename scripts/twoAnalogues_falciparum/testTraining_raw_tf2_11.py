...
testBamEdU = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/EdU_trainingData/test_forLSTM7.bam'
testBamBrdU = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/BrdU_trainingData/test_forLSTM7.bam'
...
plt.ylim(0,1)
plt.savefig(plotOutputDir + '/' + os.path.splitext(fname)[0] + '_test_forLSTM7.pdf')
plt.xlim(0,0.2)
plt.savefig(plotOutputDir + '/' + os.path.splitext(fname)[0] + '_test_forLSTM7_zoom.pdf')
plt.close()
