...
folderPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/Thym_trainingData/trainingFiles_raw'

bc08dnascent = '/home/mb915/rds/rds-mb915-notbackedup/data/2019_11_29_FT_ONT_Plasmodium_Barcoded/barcode01/DNAscentv2.CNN.raw.trainingData'
...
class trainingRead:
	...
	def __init__(self, read_sixMers, read_eventMeans, read_modelMeans, read_modelStd, read_positions, readID, label):
	...
	for line in f:
		...
		if line[0] == '>':
			...
			if len(read_sixMers) > maxLen:
				...
				if switch:
					tr = trainingRead(read_sixMers, read_eventMeans, read_modelMeans, read_modelStd, read_positions, prevReadID, label)
			...
			if pos != prevPos and prevPos != -1:
				...
				read_eventMeans.append(pos_eventMeans[0:maxRaw])
