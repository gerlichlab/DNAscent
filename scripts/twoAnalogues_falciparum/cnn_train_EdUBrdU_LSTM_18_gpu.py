...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/trainingLog_LSTM_18.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/trainingReads_LSTM_18.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/validationReads_LSTM_18.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/checkpoints_LSTM_18'
validationSplit = 0.05

f_checkpoint = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/checkpoints_LSTM_9/weights.13-0.43.h5'
...
def trainingReadToLabel(t,whichSet):
	...
	elif whichSet == 4: #is BrdU augmented into EdU
		for s in t.logLikelihood: #not thymidine
			if s == '-':
				label.append([0.98, 0.01, 0.01])
			else:
				if s == '-X': #not thymidine
					label.append([0.98, 0.01, 0.01])
				elif s[-1] == 'X': #in a swapped EdU region
					score = float(s[:-1])
					if score > llThreshold:
						l = (truePositive*incorporationEstimate)/(truePositive*incorporationEstimate + falsePositive*(1-incorporationEstimate))
						label.append([1.-l-0.005, 0.01, l-0.005])
...
def trainingReadToWeights(t):
	...
	for i, s in enumerate(t.sixMers[1:]):

		index = i+1 #because we start from index 1 but i starts from 0
		sequence = (t.sixMers[index-1] + t.sixMers[index])[2:-1] #look at the four bases flanking the potential T

		if len(sequence) != 9:
			print('Sequence issue in weights')
			sys.exit()
	...
	def __data_generation(self, list_IDs_temp):
		...
		for i, ID in enumerate(list_IDs_temp):
			...
			if 'Thym_trainingData' in ID:
				...
				whichSet = 3
			elif 'BrdUinEdU_trainingData' in ID:
				whichSet = 4
			if whichSet == -1:
...
'/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/BrdUinEdU_trainingData_raw/gap20',
'/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/BrdUinEdU_trainingData_raw/gap30', 
'/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/BrdUinEdU_trainingData_raw/gap40',    
