...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/trainingLog_LSTM_14.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/trainingReads_LSTM_14.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/validationReads_LSTM_14.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/checkpoints_LSTM_14'
validationSplit = 0.1
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    X = TimeDistributed(Bidirectional(GRU(32,return_sequences=True)))(X)
    X_shortcut = X
    X = TimeDistributed(Bidirectional(GRU(32,return_sequences=True)))(X)
    X = TimeDistributed(Bidirectional(GRU(32,return_sequences=True)))(X)
    X = Add()([X, X_shortcut])
    X = Activation('tanh')(X)
    X = TimeDistributed(Bidirectional(GRU(32,return_sequences=False)))(X)
