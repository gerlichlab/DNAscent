...
from tensorflow.python.keras.layers import LSTM, GRU, Reshape
...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/trainingLog45.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/trainingReads45.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/validationReads45.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2021_05_21_FT_ONT_Plasmodium_BrdU_EdU/modelTraining/checkpoints45'
validationSplit = 0.2
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    X = TimeDistributed(Conv1D(filters=16,kernel_size=4, padding='same'))(X_input)
...
def trainingReadToTensor(t):
	...
	for i, s in enumerate(t.sixMers):
		...
		#other features
		oneHot.append(t.eventMean[i][0])
		oneHot.append(t.eventLength[i][0])
