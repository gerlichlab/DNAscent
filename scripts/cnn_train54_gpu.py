...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLog54pt3.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingReadsUsed54.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/valReadsUsed54.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints54pt3'
validationSplit = 0.2

f_checkpoint = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints54pt2/weights.03-0.41.h5'
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    # Stage 1
    X = Conv1D(128, 12, strides = 1, padding='same', name = 'conv1', kernel_initializer = glorot_uniform(seed=0))(X_input)
    X = BatchNormalization(name = 'bn_conv1')(X)
    X = Activation('tanh')(X)
    #X = MaxPooling1D(4, strides=1, padding='same')(X)

    # Stage 2
    X = convolutional_block(X, f = 16, filters = [128, 128, 128, 128, 128, 128], stage = 2, block='a', s = 1)
    #X = identity_block(X, 4, [64, 64, 256], stage=2, block='b')
    #X = identity_block(X, 4, [64, 64, 256], stage=2, block='c')

    # Stage 3
    X = convolutional_block(X, f=8, filters=[128, 128, 128, 128, 128, 128], stage=3, block='a', s=2)
    ...
    # Stage 5
    X = convolutional_block(X, f=4, filters=[256, 256, 256, 256, 256, 256], stage=5, block='a', s=2)
    #X = identity_block(X, 4, [512, 512, 2048], stage=5, block='b')
    #X = identity_block(X, 4, [512, 512, 2048], stage=5, block='c')

    # Stage 6
    X = convolutional_block(X, f=4, filters=[512, 512, 512, 512, 512, 512], stage=6, block='a', s=2)
