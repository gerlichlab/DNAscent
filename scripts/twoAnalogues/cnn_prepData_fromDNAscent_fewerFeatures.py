...
folderPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/twoAnalogues'
...
cldu = '/home/mb915/rds/rds-mb915-notbackedup/data/2020_08_10_CAM_ONT_CldU_80/DNAscentv2.align'

inputFiles = [('thymidine', bc08dnascent, folderPath),('brdu', bc12dnascent, folderPath),('cldu', cldu, folderPath)]
maxLen = 4000
	...
	for line in f:
		...
		if line[0] == '>':
			...
			if len(read_sixMers) > maxLen:
				...
				if switch:
					tr = trainingRead(read_sixMers, read_eventMeans, read_eventStd, read_eventLength, read_modelMeans, read_modelStd, read_positions, prevReadID, label)
