...
config = tf.ConfigProto( device_count = {'GPU': 4 , 'CPU': 12} )
sess = tf.Session(config=config) 
backend.set_session(sess)


threads = 64
folderPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/data3'
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLog3.csv'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints3'
validationSplit = 0.2
...
model.add(Conv1D(128,(16),padding='same',activation='tanh',input_shape=(None,4+3)))
model.add(Conv1D(128,(16),padding='same',activation='tanh'))
model.add(Conv1D(128,(16),padding='same',activation='tanh'))
model.add(Conv1D(128,(16),padding='same',activation='tanh'))
model.add(Conv1D(128,(16),padding='same',activation='tanh'))
model.add(Conv1D(128,(16),padding='same',activation='tanh'))
...
#generator fit
model.fit_generator(generator=training_generator, validation_data=validation_generator, epochs=100, verbose=1, callbacks=[es,chk,csv], use_multiprocessing=True)
