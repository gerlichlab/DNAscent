...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLog114pt2.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingReadsUsed114.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/valReadsUsed114.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints114pt2'
validationSplit = 0.2

f_checkpoint = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints114/weights.16-0.21.h5'
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    # Stage 4
    X = convolutional_block(X, f=10, filters=[128, 128, 128, 128, 128, 128], stage=4, block='a', s=2)
    ...
    # Stage 5
    X = convolutional_block(X, f=10, filters=[128, 128, 128, 128, 128, 128], stage=5, block='a', s=2)
...
def trainingReadToTensor(t):
	...
	for i, s in enumerate(t.sixMers):
		...
		#other features
		oneHot.append(t.eventMean[i]/150.)
		oneHot.append(t.eventStd[i]/6.)
		oneHot.append(t.eventLength[i]/0.01)
		oneHot.append(t.modelMeans[i]/150.)
		oneHot.append(t.modelStd[i]/6.)
...
filepaths = ['/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/commit620d798_trainingData_8features_bc8bc12_augmentation/trainingFiles_gap10_withStd',
'/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/data_8features_bc08_withStd']
