...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLog56pt2.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingReadsUsed56.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/valReadsUsed56.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints56pt2'
validationSplit = 0.2

f_checkpoint = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints56/weights.03-0.34.h5'

maxLen = 4000
maxReads = 205000

#static params
truePositive = {0.: 0.8, 0.26: 0.8, 0.5: 0.65, 0.8: 0.5}
trueNegative = 0.95
	...
	for s in t.logLikelihood:
		if s == '-':
			...
			if score > llThreshold:
				l = (truePositive[t.analogueConc]*t.analogueConc)/(truePositive[t.analogueConc]*t.analogueConc + falsePositive*(1-t.analogueConc))
				label.append([1.-l,l])
			else:
				l = ((1-truePositive[t.analogueConc])*t.analogueConc)/((1-truePositive[t.analogueConc])*t.analogueConc + (1-falsePositive)*(1-t.analogueConc))
				label.append([1.-l,l])
...
'''
readIDs = []
f_readIDs = open('/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/commit620d798_trainingData.IDs','r')
