...
logPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingLog68.csv'
trainingReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/trainingReadsUsed68.txt'
valReadLogPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/valReadsUsed68.txt'
checkpointPath = '/home/mb915/rds/rds-mb915-notbackedup/data/2018_06_18_CAM_ONT_gDNA_BrdU_40_60_80_100_full/cnn_training/checkpoints68'
validationSplit = 0.2
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    # Stage 4
    X = convolutional_block(X, f=5, filters=[32, 32, 32, 32, 32, 32], stage=4, block='a', s=2)
    ...
    # Stage 5
    X = convolutional_block(X, f=5, filters=[32, 32, 32, 32, 32, 32], stage=5, block='a', s=2)
    #X = identity_block(X, 4, [512, 512, 2048], stage=5, block='b')
    #X = identity_block(X, 4, [512, 512, 2048], stage=5, block='c')

    # Stage 6
    X = convolutional_block(X, f=5, filters=[64, 64, 64, 64, 64, 64], stage=6, block='a', s=2)
