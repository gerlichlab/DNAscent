...
from tensorflow.keras.layers import Flatten, Input, Dense, Attention, Conv1D, Activation, BatchNormalization, SeparableConv1D, TimeDistributed, MultiHeadAttention, AdditiveAttention, Attention, Concatenate, Masking, LSTM, GRU, Bidirectional, Add, SeparableConv1D, Dropout
...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_71.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_71.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_71.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/71'
...
def buildModel(classes = 3, numTrainingReads=100000):
    ...
    # Stage 1
    X = get_convolutional_reparameterization_layer(64, 9, divergence_fn)(X)
    
    # Stage 2
    X = convolutional_block(X, divergence_fn, f=9, filters = [64, 64, 64, 64, 64, 64], stage = 2, block='a', s = 1)
    
    # Stage 3
    #X = convolutional_block(X, divergence_fn, f=9, filters=[64, 64, 64, 64, 64, 64], stage=3, block='a', s=2)
    
    # Stage 4
    X = convolutional_block(X, divergence_fn, f=13, filters=[128, 128, 128, 128, 128, 128], stage=4, block='a', s=2)
