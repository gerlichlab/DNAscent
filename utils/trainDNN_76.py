...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_76.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_76.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_76.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/76'
validationSplit = 0.1
...
def buildModel(classes, core_embedding_layer, residual_embedding_layer):
    ...
    X_signal = TimeDistributed(Bidirectional(GRU(8,return_sequences=True)))(X_signal)
    X_signal = TimeDistributed(Bidirectional(GRU(8,return_sequences=False)))(X_signal)
