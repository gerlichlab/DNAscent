...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_30.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_30.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_30.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/30'
validationSplit = 0.1
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    # Noise model
    X = TimeDistributed(Dense(classes, activation='linear',use_bias=False))(X)
    X = SpatialDropout1D(dropout_prob)(X)
    #X = Dropout(dropout_prob)(X)
    #X = TimeDistributed(Dropout(dropout_prob))(X)
    X = TimeDistributed(Dense(classes, activation='softmax', kernel_initializer = glorot_uniform(seed=0)))(X)    
...
#generator fit
model.fit_generator(generator=training_generator, validation_data=validation_generator, epochs=3, verbose=1, callbacks=[es,chk,csv])
