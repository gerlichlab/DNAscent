...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_90_transfer4.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_90_transfer4.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_90_transfer4.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/90_transfer4'
	...
	if whichSet == 0.:
		...
		for i, s in enumerate(t.BrdUCalls):
			if s == '-' or s[-1] == 'X': #not thymidine or augmented-negative
				...
				score = max(float(t.BrdUCalls[i]), float(t.EdUCalls[i]))
