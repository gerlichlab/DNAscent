...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_62.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_62.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_62.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/62'
validationSplit = 0.1
...
def negative_log_likelihood(y_true, y_pred):
	# Clip y_pred to avoid log(0) or log(1) which would result in NaN
	epsilon = 1e-7
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    X = Convolution1DReparameterization(256, 3, strides = 1, padding='same', activation='relu', name = 'conv2')(X)

    X = Convolution1DReparameterization(128, 3, strides = 1, padding='same', activation='relu', name = 'conv3')(X)

    X = Convolution1DReparameterization(64, 3, strides = 1, padding='same', activation='relu', name = 'conv4')(X)

    # Output layer
    X = TimeDistributed(DenseReparameterization(classes, name='fc' + str(classes), activation='softmax'))(X)
...
with strategy.scope():
	...
	model.compile(optimizer=op, metrics=['accuracy'], loss=negative_log_likelihood, sample_weight_mode="temporal")
	print(model.summary())
