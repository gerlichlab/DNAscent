...
checkpointPath="/home/mb915/rds/hpc-work/development/DNAscent_R10align/DNAscent_dev/utils/kmer_embedding_checkpoints3"
...
#
sequence = []
f = open('core_5mers_sorted.txt','r')
for line in f:
...
model.fit([targets, contexts], labels, validation_split=0.1, epochs=1000, batch_size=32, callbacks=[chk,es])

model.save('kmer_core_embedding')
