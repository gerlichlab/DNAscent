...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_32.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_32.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_32.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/32'
validationSplit = 0.1
...
def convolutional_block(X, f, filters, stage, block, s=1):
    ...
    ##### SHORTCUT PATH #### 
    X_shortcut = Convolution1DFlipout(filters=F6, kernel_size=f, strides=1, padding='same', name=conv_name_base + '1')(X_shortcut)
