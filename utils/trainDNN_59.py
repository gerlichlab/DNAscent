...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_59.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_59.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_59.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/59'
validationSplit = 0.1
...
def convolutional_block(X, f, filters, stage, block, s=1):
    ...
    X = Convolution1DReparameterization(filters=F1, kernel_size=f, strides=1, padding='same', name=conv_name_base + '2a')(X)
    X = BatchNormalization(name=bn_name_base + '2a')(X)
    X = Activation('relu')(X)

    # Second component of main path
    X = Convolution1DReparameterization(filters=F2, kernel_size=f, strides=1, padding='same', name=conv_name_base + '2b')(X)
    X = BatchNormalization(name=bn_name_base + '2b')(X)
    X = Activation('relu')(X)

    # Third component of main path
    X = Convolution1DReparameterization(filters=F3, kernel_size=f, strides=1, padding='same', name=conv_name_base + '2c')(X)
    X = BatchNormalization(name=bn_name_base + '2c')(X)
    X = Activation('relu')(X)

    # Fourth component of main path
    X = Convolution1DReparameterization(filters=F4, kernel_size=f, strides=1, padding='same', name=conv_name_base + '2d')(X)
    X = BatchNormalization(name=bn_name_base + '2d')(X)
    X = Activation('relu')(X)

    # Fifth component of main path
    X = Convolution1DReparameterization(filters=F5, kernel_size=f, strides=1, padding='same', name=conv_name_base + '2e')(X)
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    # Stage 1
    X = Convolution1DReparameterization(64, 3, strides = 1, padding='same', name = 'conv1')(X)
    ...
    X = Convolution1DReparameterization(256, 3, strides = 1, padding='same', name = 'conv2')(X)
    X = BatchNormalization(name = 'bn_conv2')(X)
    X = Activation('relu')(X)

    X = Convolution1DReparameterization(128, 3, strides = 1, padding='same', name = 'conv3')(X)
    X = BatchNormalization(name = 'bn_conv3')(X)
    X = Activation('relu')(X)

    X = Convolution1DReparameterization(64, 3, strides = 1, padding='same', name = 'conv4')(X)

    # Output layer
    X = TimeDistributed(DenseReparameterization(classes, activation='softmax', name='fc' + str(classes)))(X)
