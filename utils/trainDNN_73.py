...
from tensorflow.keras.layers import Flatten, MaxPooling1D, Input, Dense, Attention, Conv1D, Activation, BatchNormalization, SeparableConv1D, TimeDistributed, MultiHeadAttention, AdditiveAttention, Attention, Concatenate, Masking, LSTM, GRU, Bidirectional, Add, SeparableConv1D, Dropout
...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_72.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_72.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_72.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/72'
...
def buildModel(classes = 3, numTrainingReads=100000):
    ...
    sequence_input = Input(shape=(2000,5))
    
    signal_input = Input(shape=(2000,1))

    X = Concatenate(axis=-1)([sequence_input,signal_input])

    # Stage 1
    X = get_convolutional_reparameterization_layer(16, 3, divergence_fn)(X)
    #X = get_convolutional_reparameterization_layer(64, 5, divergence_fn)(X)
    X = MaxPooling1D(2,2)(X)
    X = get_convolutional_reparameterization_layer(32, 9, divergence_fn)(X)
...
def trainingReadToTensor(t):
	...
	return t.sequence_tensor, t.signal_tensor[:,0]
...
class DataGenerator(Sequence):
	...
	def __data_generation(self, list_IDs_temp):
		...
		for i, ID in enumerate(list_IDs_temp):
			...
			X2[i,] = signal_tensor.reshape(signal_tensor.shape[0], 1)
...
model.compile(optimizer=RMSprop(), metrics=['accuracy'], loss=nll)#, run_eagerly=True)
print(model.summary())
