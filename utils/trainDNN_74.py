...
logPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingLog_DNN_74.csv'
trainingReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/trainingReads_DNN_74.txt'
valReadLogPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/logs/validationReads_DNN_74.txt'
checkpointPath = '/home/mb915/rds/rds-boemo_3-tyMgmffheQw/workspace/R10_4_1_DNAtraining/checkpoints/74'
validationSplit = 0.1
...
class trainingRead:
	...
	def __init__(self, read_kmers, read_signals, read_modelMeans, read_positions, readID, label):
...
def buildModel(input_shape = (64, 64, 3), classes = 6):
    ...
    #base sequence input
    sequence_input = Input(shape=(2000))
    X_sequence = Embedding(4**9, 48)(sequence_input)
    ...
    X = Concatenate(axis=-1)([X_sequence, X_signal, X_model])
    ...
    # Create model
    model = Model(inputs = [sequence_input, model_input, signal_input] , outputs = X, name='R10_BrdU_EdU')
...
def trainingReadToTensor(t):
	...
	return np.array(t.kmers).reshape(2000), np.array(t.modelMeans).reshape(2000,1), t.signal_tensor
...
class DataGenerator(Sequence):
	...
	def __data_generation(self, list_IDs_temp):
		...
		for i, ID in enumerate(list_IDs_temp):
			...
			# input tensors
			sequence_tensor, model_tensor, signal_tensor = trainingReadToTensor(trainingRead)
